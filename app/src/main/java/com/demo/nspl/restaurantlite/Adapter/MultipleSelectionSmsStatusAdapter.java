...
public class MultipleSelectionSmsStatusAdapter extends RecyclerView.Adapter<MultipleSelectionSmsStatusAdapter.myViewHolder> {
    ...
    public MultipleSelectionSmsStatusAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        ...
        holder.txt_label.setText(obj.getStatus().toUpperCase());
