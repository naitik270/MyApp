...
public class MultipleSelectionTitleAdapter extends RecyclerView.Adapter<MultipleSelectionTitleAdapter.myViewHolder> {
    ...
    public MultipleSelectionTitleAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        ...
        holder.txt_label.setText(obj.getTitle().toUpperCase());
