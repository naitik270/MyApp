...
public class ClsExportSingleVendorData {
    ...
    public static List<ClsExportSingleVendorData> getVendorList(Context context, int _vendorID) {

        List<ClsExportSingleVendorData> list = new ArrayList<>();
        ...
        try {
            ...
            String qry = ClsGlobal.exportVendorPayment(context);

            qry = qry.replace("#_vendorID", String.valueOf(_vendorID));
            ...
            while (cur.moveToNext()) {
                ClsExportSingleVendorData getSet = new ClsExportSingleVendorData();
                ...
                getSet.set_date(cur.getString(cur.getColumnIndex("Date")));
