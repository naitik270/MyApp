...
import static com.demo.nspl.restaurantlite.Global.ClsGlobal.CreateBillSettingFile;
...
public class Bill_No_Format_Tax_ApplyFragment extends Fragment implements TextWatcher {

    private TextView txt_preview, id_separator, from_date, to_date;
    private LinearLayout main_fy;
    private RadioGroup rg_Financial_Year, rg_Year, rg_Separator, rg_Reset_Counter,
            rg_month;
    ...
    private RadioButton rbCCYYdashCCnYY, rbYYdashnYY, rbCCYYnYY, rbYYnYY,
            rbCCYYdashnYY, rbCCYYCCnYY,
            rbCCYY, rbYY, rb_allow_zero, rb_No_zero,rb_forward_slash
    ...
    RadioButton rb_last_year, rb_last_2year;

    public Bill_No_Format_Tax_ApplyFragment() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CreateBillSettingFile("TaxNotApply", getActivity());
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bill__no__format__tax__apply,
                container, false);
...
//        id_month = view.findViewById(R.id.id_month);
        ...
        main_fy = view.findViewById(R.id.main_fy);
...
//            edt_bill_start_form.setText("00");
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.clear) {
            ClsGlobal.clearBillFormat(getActivity(), "ApplyTax");
...
//        String string = String.format("%0" + (edt_bill_no_length.getText()
//                        .toString().trim()) + "d",
//                Integer.parseInt(edt_bill_start_form.getText().toString().trim()
//                        .equalsIgnoreCase("") ? "1"
//                        : edt_bill_start_form.getText().toString().trim()));
//
//        Toast.makeText(getActivity(), string, Toast.LENGTH_LONG).show();
//        Log.e("check", "format error:- " + string);
            ...
            if (!edt_bill_start_form.getText().toString().trim().equalsIgnoreCase("")) {
                ...
                if (cb_FY.isChecked()) {
                    if (!from_date.getText().toString().equalsIgnoreCase("FROM DATE") &&
                        ...
                        clsBillNoFormat.setFinancial_Year_format(GetSelected_rg_value(rg_Financial_Year, "GetTag"));
//                        clsBillNoFormat.setFinancial_Year_rb_id(getSelectedIndexRadioGroup(rg_Financial_Year));
...
//                clsBillNoFormat.setMonth_rb_id(getSelectedIndexRadioGroup(rg_month));
                clsBillNoFormat.setSelected_Month_rb(getSelectedIndexRadioGroup(rg_month));

                Log.e("Check", "Month_rb: " + getSelectedIndexRadioGroup(rg_month));
...
//                clsBillNoFormat.setSeparator_rb_id(getSelectedIndexRadioGroup(rg_Separator));
                clsBillNoFormat.setSelected_Separator_rd(getSelectedIndexRadioGroup(rg_Separator));

                clsBillNoFormat.setBill_Start_Form(edt_bill_start_form.getText()
                        .toString().trim());

                clsBillNoFormat.setBill_no_length(edt_bill_no_length.getText()
                        .toString().trim()
                        .equalsIgnoreCase("") ? "1" :
                        edt_bill_no_length.getText().toString().trim());

                clsBillNoFormat.setReset_Counter_Name(GetSelected_rg_value(rg_Reset_Counter, ""));
//                clsBillNoFormat.setReset_Counter_rb_id(getSelectedIndexRadioGroup(rg_Reset_Counter));
                ...
                clsBillNoFormat.setResetCounter(
                        get_Current_Day_Month_Yearly(GetSelected_rg_value(rg_Reset_Counter,
                                "")));
//            clsBillNoFormat.setResetCounter("3");
                ...
                int result = ClsInventoryOrderMaster.UpdateOrderSequence(getActivity()
                        , String.valueOf(Integer.valueOf(edt_bill_start_form.getText().toString().trim()) - 1),
                        "YES");
                ...
                Toast.makeText(getActivity(), "Bill start form must not be empty!",
...
//            Log.e("Check", "!= null: - " + clsBillNoFormat.getPrefix());
            ...
            formatsFinancialYear(clsBillNoFormat.getFinancial_Year_format(),
                    clsBillNoFormat, "YES", getActivity());
...
//            rg_Financial_Year.check(clsBillNoFormat.getFinancial_Year_rb_id());
//            SetBillNoPreview();
