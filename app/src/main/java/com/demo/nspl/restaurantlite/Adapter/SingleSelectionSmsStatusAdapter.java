...
public class SingleSelectionSmsStatusAdapter extends RecyclerView.Adapter<SingleSelectionSmsStatusAdapter.myViewHolder> {
    ...
    public SingleSelectionSmsStatusAdapter(Context context) {
