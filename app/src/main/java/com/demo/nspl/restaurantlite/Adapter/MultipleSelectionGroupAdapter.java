...
public class MultipleSelectionGroupAdapter extends RecyclerView.Adapter<MultipleSelectionGroupAdapter.myViewHolder> {
    ...
    public MultipleSelectionGroupAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        ...
        holder.txt_label.setText(obj.getGroupName().toUpperCase());
