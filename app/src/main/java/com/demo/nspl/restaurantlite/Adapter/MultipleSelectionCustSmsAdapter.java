...
public class MultipleSelectionCustSmsAdapter extends RecyclerView.Adapter<MultipleSelectionCustSmsAdapter.myViewHolder> {

    Context context;
    List<ClsBulkSMSLog> mData;
    OnCharacterClick mOnCharacterClick;
    boolean isSelected[];
    public static List<String> selectedItems =new ArrayList<>();

    public MultipleSelectionCustSmsAdapter(Context context) {
        this.context = context;

    }

    public void AddItems(List<ClsBulkSMSLog> mData){
        this.mData = mData;
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        ClsBulkSMSLog obj = mData.get(position);
        holder.txt_label.setText(obj.getCustomerName() + " (" + obj.getMobile() + ")");
    ...
    public interface OnCharacterClick {
        void OnClick(ClsBulkSMSLog clsCustomerMaster, int position, myViewHolder holder);
    }
    ...
    public static class myViewHolder extends RecyclerView.ViewHolder {
        ...
        void Bind(ClsBulkSMSLog clsCustomerMaster,
                  OnCharacterClick mOnCharacterClick,
                  int position,
                  myViewHolder holder) {
    ...
    List<ClsBulkSMSLog> selected;

    public List<ClsBulkSMSLog> getSelected() {
        return selected;
    }

    public void updateList(List<ClsBulkSMSLog> list) {
        mData = list;
        notifyDataSetChanged();
    }
