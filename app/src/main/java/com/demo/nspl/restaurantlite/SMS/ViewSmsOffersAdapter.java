...
public class ViewSmsOffersAdapter extends RecyclerView.Adapter<ViewSmsOffersAdapter.MyViewHolder> {
    ...
    public ViewSmsOffersAdapter(Context context, List<ClsViewSmsOffersList> data) {
        super();
        this.data = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_view_sms_offers_bottom_dialog, parent, false);
